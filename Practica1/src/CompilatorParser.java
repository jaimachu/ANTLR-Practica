	...
	public final CtedefContext ctedef() throws RecognitionException {
		...
		try {
			...
			((CtedefContext)_localctx).simpvalue = simpvalue();
			    ...
			    String v = "<span style=\"font-weight: bold;\">#define</span> <span CLASS=\"ident\">"+ (((CtedefContext)_localctx).CONST_DEF_IDENTIFIER!=null?((CtedefContext)_localctx).CONST_DEF_IDENTIFIER.getText():null) +"</span>";
		...
		try {
			...
			case 2:
				...
				((FactorContext)_localctx).IDENTIFIER = match(IDENTIFIER);
				 ((FactorContext)_localctx).value =  "<span class =\"ident\">"+(((FactorContext)_localctx).IDENTIFIER!=null?((FactorContext)_localctx).IDENTIFIER.getText():null)+"</span>";
				}
				break;
			case 3:
				enterOuterAlt(_localctx, 3);
	...
	public final FunccallContext funccall() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				...
				((FunccallContext)_localctx).value =  "<a href=\"#"+ (((FunccallContext)_localctx).IDENTIFIER!=null?((FunccallContext)_localctx).IDENTIFIER.getText():null) +"\">" + (((FunccallContext)_localctx).IDENTIFIER!=null?((FunccallContext)_localctx).IDENTIFIER.getText():null) +"</a>" + ((FunccallContext)_localctx).subpparamlist.value;
				}
				break;
			case CONST_DEF_IDENTIFIER:
				enterOuterAlt(_localctx, 2);
