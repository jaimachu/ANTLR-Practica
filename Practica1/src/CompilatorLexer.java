...
public class CompilatorLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__17", "ESPACIO", "SALTOS", "CONST_DEF_IDENTIFIER", "IDENTIFIER", "NUMERIC_REAL_CONST", 
			"NUMERIC_INTEGER_CONST", "STRING_CONST", "COMENTARIO_SIMPLE", "COMENTARIO_PAREJA", 
			"DOBLES", "SIMPLES", "PUNTO", "BARRA", "BARRA_BARRA", "ANYCHAR", "NEW_LINE"
		};
	}
